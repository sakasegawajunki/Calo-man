...
describe 'ユーザログイン後のテスト' do
  ...
  describe '摂取カロリー入力画面のテスト' do
    ...
    #   before do
    #     visit cal_balances_path
    #     visit edit_cal_ingestion_path(cal_ingestion.last.id)
    #     byebug
    #     subject { current_path }
    #   end
    #   it '新しい摂取カロリーが正しく更新される' do
