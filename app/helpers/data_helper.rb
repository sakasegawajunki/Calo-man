module DataHelper
  ...
  def week_total_cal_balances
    ...
    # now = Time.current
    # @cal_ingestion.find_by(created_at: now.beginning_of_week..now.end_of_week)&.total_cal_ingestions.to_i - @cal_consumption.find_by(created_at: now.beginning_of_week..now.end_of_week)&.total_cal_consumptions.to_i
  end
